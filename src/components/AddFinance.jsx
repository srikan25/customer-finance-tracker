...
const AddFinance = ({ customer, userId, onFinanceAdded, onClose }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const monthlyEmiAmount = Number(emiAmount);
      ...
      if (interestRate === "") {
        throw new Error("Please enter the rate of interest.");
      }
      ...
      if (!emiAmount) {
        throw new Error("Please enter the monthly EMI amount.");
      }

      if (monthlyEmiAmount <= 0) {
        throw new Error("Monthly EMI amount must be greater than 0.");
      }
    ...
    <div className="finance-overlay" onClick={onClose}>
      ...
      >
        ...
        <form className="add-finance-form" onSubmit={handleSubmit}>
          ...
          {financeAmount > 0 && totalEmis && Number(emiAmount) > 0 && (
            <div className="finance-summary">
              ...
              <div>
                ...
                <strong>₹{Number(emiAmount).toLocaleString("en-IN")}</strong>
              </div>
            </div>
          )}
          ...
          <button
            ...
            disabled={loading || Boolean(downPaymentError)}
          >
